...
**Estado actual: v1.25.0** — Documentación visual completa: 5 capturas de pantalla agregadas (home, login, registro, categorías, productos) con 2.5MB de documentación visual optimizada, corrección de mensajes flash flotantes, y README completamente ilustrado.

• Changelog: ver [CHANGELOG.md](https://github.com/jhonatanfdez/crud-symfony-test/blob/main/archivos_adicionales/CHANGELOG.md) · Tag: [v1.25.0](https://github.com/jhonatanfdez/crud-symfony-test/releases/tag/v1.25.0)
